...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run optimization with local MCP stdio runner")
    ...
    if args.save_artifact:
        path = save_artifact(result, artifact_dir=args.artifact_dir, prefix="optimize_mcp_stdio")

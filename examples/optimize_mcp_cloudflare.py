...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run optimization against Cloudflare MCP streamable-http")
    ...
    if args.save_artifact:
        path = save_artifact(result, artifact_dir=args.artifact_dir, prefix="optimize_mcp_cloudflare")
